    ...
    <div class="container mt-5">
        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method="post">
                ...
                <div class="mt-3">
                    <button class="btn btn-simpan" type="submit" name="simpan_kategori">Simpan</button>
                </div>
            </form>
            ...
            <?php 
                if(isset($_POST['simpan_kategori'])){
                    ...
                    $queryExist = mysqli_query($conn, "SELECT nama_kategori FROM kategori WHERE nama_kategori='$kategori'");
                    ...
                    if($jumlahDataKategoriBaru > 0){
                        ...
                        $querySimpan = mysqli_query($conn, "INSERT INTO kategori (nama_kategori) VALUES ('$kategori')");
